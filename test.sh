...
DPC="$IMGDIR$POSch1t1.tiff"
G="$IMGDIR$POSch2t1.tiff"
R="$IMGDIR$POSch3t1.tiff"
FR="$IMGDIR$POSch4t1.tiff"

C_OUT="$RESULTSDIR$POS_mask.tiff"
N_OUT="$RESULTSDIR$POS_Nmask.tiff"
echo $DPC 
echo $C_OUT
